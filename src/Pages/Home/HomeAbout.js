...
export default function HomeAbout() {
    return (
        ...
        <div class="hero min-h-screen">
            <div class="hero-content lg:justify-center flex-col lg:flex-row">
                ...
                <div className="lg:max-w-lg px-12 space-y-6">
                    <h1 class="lg:text-4xl text-2xl text-neutral font-bold">Let us handle your <span>skin <span className="text-accent">Professionally</span></span>.</h1>
                    ...
                    <div class="flex items-center justify-between w-3/4">
                        <div>
                            <h2 className="text-accent text-2xl font-bold my-5">500+</h2>
                            <p class="text-black">Happy Customer</p>
                        </div>
                        <div>
                            <h2 className="text-accent text-2xl font-bold my-5">16+</h2>
