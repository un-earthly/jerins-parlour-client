...
export default function HomeAbout() {
    return (
        ...
        <div className="hero min-h-screen py-10">
            <div className="hero-content lg:justify-center flex-col-reverse lg:flex-row">
                <div className="lg:max-w-lg flex items-center justify-between">
                    <img src="https://raw.githubusercontent.com/ProgrammingHero1/jerins-parlour/main/Image_Icon/Image/engin-akyurt-g-m8EDc4X6Q-unsplash%201.png" className="w-full rounded-lg" />
                </div>
                <div className="lg:max-w-lg lg:px-12 space-y-6">
                    <h1 className="text-4xl text-neutral font-bold">Let us handle your <span>skin <span className="text-accent">Professionally</span></span>.</h1>
